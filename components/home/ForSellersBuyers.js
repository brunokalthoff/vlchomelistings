    ...
    <div className={styles.container}>
      <div className={styles.wrapper}>
        <div className={styles.text}>
          ...
          <h5>
            Most home sellers dream of a stress-free sale in which they simply list their house, quickly find a
            qualified buyer, collect the cash and hand over the keys. If only it were that simple! In reality, selling a
            home involves many moving parts - some that you can control, and some that are out of your hands.
          </h5>
      ...
      <div className={styles.wrapper}>
        ...
        <div className={styles.text}>
          ...
          <h5>
            Buying a home can be challenging for a first-timer. After all, there are so many steps, tasks, and
            requirements, and you may be anxious about making an expensive mistake. But first-time homebuyers enjoy some
            special advantages created to encourage new entrants into the real estate market. Allow us to work for you!
          </h5>
          <div className={styles.button}>
            <Link href="/buyers">
              <a>Buy your home</a>
